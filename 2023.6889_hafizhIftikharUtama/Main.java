...
public class Main {
    public static void main(String[] args) {
        ...
        Armor armor1 = new Armor("Iron Armor", 10, 40);
        Weapon weapon1 = new Weapon("Iron Sword", 30);
        player1.setArmor(armor1);
        player1.setWeapon(weapon1);

        Player player2 = new Player("Tono");
        Armor armor2 = new Armor("Leather Armor", 5, 20);
        Weapon weapon2 = new Weapon("Rusty Sword", 15);
